 ...
 *
 * \retval factor Current Signal Bandwidth value 
...
/*!
 * \brief Get LoRa signal bandwidth value in kHz
 *
 * \retval Signal bandwidth value in kHz [7.8kHz, 10.4 kHz, 5.6 kHz, 20.8 kHz, 
 * 							31.2 kHz, 41.6 kHz, 62.5 kHz, 125 kHz, 250 kHz, 500 kHz]
 */
const char * SX1276LoRaGetSignalBandwidthValue( void );

/*!
 * \brief Writes the new Spreading Factor value
 *
 * \param [IN] factor New Spreading Factor value [6, 7, 8, 9, 10, 11, 12]
 */
 ...
 *
 * \retval factor Current Spreading Factor value [6, 7, 8, 9, 10, 11, 12] 
 */
uint8_t SX1276LoRaGetSpreadingFactor( void );

/*!
 * \brief Get LoRa spreading factor in chirps
 *
 * \retval Spreading factor number [64, 128, 256, 512, 1024, 2048, 4096] chirps
 * 
 */
const char * SX1276LoRaGetSpreadingFactorInChirps();
...
/*!
 * \brief Get LoRa error coding rate binary value
 *
 * \retval Error coding rate binary value 
 */
uint8_t SX1276LoRaGetCRCBin();

/*!
 * \brief Get LoRa error coding rate fraction value
 *
 * \retval Error coding rate fraction value [4/5, 4/6, 4/7, 4/8]
 * 
 */
const char * SX1276LoRaGetCRCValue();
...
/*!
 * \brief Get LoRa implicit header mode
 *
 * \retval Returns 1 if implicit header mode is on, 0 otherwise
 */
uint8_t SX1276LoRaGetImplicitHeader();
...
/*!
 * \brief Set LoRa detection treshold
 *
 * \param Detection treshold. 0x0A for SF 7 to 12 or 0x0C for SF 6
 */
void SX1276LoRaSetRegDetectionTreshold( uint8_t value );

/*!
 * \brief Get LoRa detection treshold
 *
 * \retval detection treshold
 */
uint8_t SX1276LoRaGetRegDetectionTreshold( void );
