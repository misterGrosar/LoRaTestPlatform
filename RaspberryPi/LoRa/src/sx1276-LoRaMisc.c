...
const char * SX1276LoRaGetSignalBandwidthValue()
{
	SX1276Read( REG_LR_MODEMCONFIG1, &SX1276LR->RegModemConfig1 );
	uint8_t bw = ( SX1276LR->RegModemConfig1 & 0xF0 ) >> 4;
...
{
	SX1276Read( REG_LR_MODEMCONFIG2, &SX1276LR->RegModemConfig2 );
	uint8_t sf = ( SX1276LR->RegModemConfig2 & 0xF0 ) >> 4;
...
{
	SX1276Read( REG_LR_MODEMCONFIG1, &SX1276LR->RegModemConfig1 );
	return ( SX1276LR->RegModemConfig1 & 0xE ) >> 1;
}

const char * SX1276LoRaGetCRCValue()
{
	SX1276Read( REG_LR_MODEMCONFIG1, &SX1276LR->RegModemConfig1 );
	uint8_t crc = ( SX1276LR->RegModemConfig1 & 0xE ) >> 1;
...
{
	SX1276Read( 0x37, &SX1276LR->RegDetectionThreshold );
    SX1276LR->RegDetectionThreshold = ( SX1276LR->RegDetectionThreshold & 0xF0) | value;
    SX1276Write( 0x37, SX1276LR->RegDetectionThreshold );
}

uint8_t SX1276LoRaGetRegDetectionTreshold( void )
{
    SX1276Read( 0x37, &SX1276LR->RegDetectionThreshold );
    return ( SX1276LR->RegDetectionThreshold );
}
